...
CLASS_DECLARATION( jkSimpleForcePower, jkForceTrick )
END_CLASS


/*
================
jkForceTrick::Event_DoForcePower
================
*/
void jkForceTrick::Event_DoForcePower( void ) {
	...
	for( i = 0; i < listedEntities; i++ ) {
			...
			ent->ForcePowerResponse(this, this, dir, "mindtrick", 1, INVALID_JOINT);
