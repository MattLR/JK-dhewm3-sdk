...
#ifndef __GAME_FORCE_H__
#define __GAME_FORCE_H__
...
class jkFP : public idClass {

public:
	CLASS_PROTOTYPE(jkFP);
...
class jkSimpleForcePower : public idAnimatedEntity {
public:
	CLASS_PROTOTYPE( jkSimpleForcePower );

							jkSimpleForcePower();
	virtual					~jkSimpleForcePower();

    void				    Init( idPlayer* _owner, const idDeclEntityDef* def, int forceIndex );
...
class jkForcePower : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForcePower );

	void					BeginAttack( void );
	void					BeginAttackAlt( void );
};

ID_INLINE bool jkSimpleForcePower::IsLinked( void ) {
	return isLinked;
}

ID_INLINE bool jkSimpleForcePower::IsWorldModelReady( void ) {
	return ( worldModel.GetEntity() != NULL );
}

ID_INLINE idPlayer* jkSimpleForcePower::GetOwner( void ) {
	return owner;
}

class jkForceAbsorb : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForceAbsorb );

	void					Event_DoForcePower( void );
};

class jkForceDrain : public jkSimpleForcePower {
public:
...
public:
	CLASS_PROTOTYPE( jkForceGrip );

	void					Event_DoForcePower( void );
};

class jkForceHeal : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForceHeal );

	void					Event_DoForcePower( void );
};

class jkForceLightning : public jkSimpleForcePower {
public:
...
public:
	CLASS_PROTOTYPE( jkForceProtection );

	void					Event_DoForcePower( void );
};

class jkForcePull : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForcePull );

	void					Event_DoForcePower( void );
};

class jkForceRage : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForceRage );

	void					Event_DoForcePower( void );
};

class jkForceSense : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForceSense );

	void					Event_DoForcePower( void );
};

class jkForceSpeed : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForceSpeed );

	void					Event_DoForcePower( void );
};

class jkForceTrick : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForceTrick );

	void					Event_DoForcePower( void );
};

class jkForcePush : public jkSimpleForcePower {
public:
	CLASS_PROTOTYPE( jkForcePush );

	void					Event_DoForcePower( void );
};

#endif /* !__GAME_FORCE_H__ */
