...
idCVar si_maxPlayers(				"si_maxPlayers",			"8",			CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_INTEGER, "max number of players allowed on the server", 1, 32 );
...
// Dynamix
idCVar si_nextLayer(				"si_nextLayer",				"",				CVAR_GAME | CVAR_SERVERINFO | CVAR_ARCHIVE, "layer to use on next map load" );
...
idCVar ai_freeze(					"ai_freeze",				"0",			CVAR_GAME | CVAR_BOOL, "pauses AI thinking" );
